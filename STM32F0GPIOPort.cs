...
namespace Antmicro.Renode.Peripherals.GPIOPort
{
    ...
    public class STM32F0GPIOPort : BaseGPIOPort, IDoubleWordPeripheral
    {
        public STM32F0GPIOPort(Machine machine, uint modeResetValue = 0, uint outputSpeedResetValue = 0, uint pullUpPullDownResetValue = 0) : base(machine, 16)
        {
        ...
        public uint ReadDoubleWord(long offset)
        {
            ...
            case Registers.GPIOx_AFRH: // GPIO alternate function high register
                ...
                break;
            case Registers.GPIOx_BRR: // GPIO port bit set/reset register
                returnValue = 0;
                break;
            default:
        ...
        private enum Registers
        {
            ...
            GPIOx_BRR       = 0x28  // GPIO port bit reset register - Write-Only
        }
    }
}
